...
//var destinationPath = path.resolve('~/home_windows/Projetos/base-wallet/tempBuild/');
var destinationPath = '/home/spooner/home_windows/Documents/Australopitech/base/tempBuild';
...
var options = {
  ...
  plugins: [
    ...
    new CopyWebpackPlugin({
      patterns: [
        { from: 'src/assets/img/icon-128.png', to: destinationPath, force: true },
        { from: 'src/assets/img/icon-34.png', to: destinationPath, force: true },
        { from: 'src/assets/img/dapp_favicon_default@2x.png', to: destinationPath, force: true },
      ],
    }),
