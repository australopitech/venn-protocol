...
const CopyIcon = () => {
  return (
    <svg fill="#F0A6CA" height="20px" viewBox="0 0 82 100" width="20px" xmlns="http://www.w3.org/2000/svg">
  ...
  return (
    <div className={styles.yourNftsContainer}>
      ...
      <div>
        ...
        <div className={nftsContext === 'borrowed' ? styles.menuItemSelected : styles.menuItem}>
          <span>
            Borrowed
          </span>
          {nftsContext === 'borrowed' 
            ? <SelectedIcon />
            : <></>
          }
        </div>
