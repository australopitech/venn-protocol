...
export const CollectionDialog = ({
    ...
    return (
        <div className={styles.collectionDialogBackdrop} onClick={stopPropagation}>
          <dialog className={styles.collectionDialog} onClick={onCloseDialog} open>
            <div className={styles.collectionDialogContent}>
              {/* <div className={styles.collectionImageContainer}>
                <div className={styles.collectionImagePreview}>
                  <img
              ...
              <div className={styles.collectionDescriptionContainer}>
                Coming soon...
              </div>
            </div>
          </dialog>
